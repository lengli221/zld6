...
NVIC_INT_CTRL   EQU     0xE000ED04                              ; Interrupt control state register
NVIC_SYSPRI14    EQU     0xE000ED22                              ; System priority register (14)
NVIC_PENDSV_PRI EQU           0xFF                              ; PendSV priority value (lowest)                              ; PendSV priority value (highest)
NVIC_PENDSVSET  EQU     0x10000000                              ; Value to trigger PendSV exception
...
OS_CPU_PendSVHandler
    ...
    CBZ     R0, OS_OSPendSV_nosave                                 ; skip register save the first time
